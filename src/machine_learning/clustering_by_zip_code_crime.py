...
# Gathering crime data for only the three most common occurring zipcodes
data = data.loc[(data['zip_code'] == 78741) | (data['zip_code'] == 78753) | (data['zip_code'] == 78758)]
...
data_trimmed = data[['crime_type_x', 'family_violence', 'temp', 'humidity', 'Avg. Income/H/hold', 'food_deprived_50', 'food_deprived_25', 'food_deprived_10']]
...
data_pca = data_pca.merge(data[['crime_type_x', 'family_violence', 'zip_code', 'temp', 'Avg. Income/H/hold', 'food_deprived_50', 'food_deprived_25', 'food_deprived_10']],left_index=True, right_index=True)
...
fig = px.scatter_3d(
    ...
    hover_data=["crime_type_x", "zip_code", 'temp', 'Avg. Income/H/hold', 'food_deprived_50', 'food_deprived_25', 'food_deprived_10'],
    color="class",
    width=1200)
...
fig.write_html("file_zip_code.html")
